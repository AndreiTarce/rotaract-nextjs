...
export const CatrafusaleRaffleRegistrationSchema = new Schema<ICatrafusaleRaffleRegistration>(
    {
        name: String,
        email: String,
        phone_number: String,
...
const CatrafusaleRaffleRegistration =
    ...
    mongoose.model('CatrafusaleRaffleRegistration', CatrafusaleRaffleRegistrationSchema);
