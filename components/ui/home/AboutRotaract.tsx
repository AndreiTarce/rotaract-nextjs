...
const firstParagraph = (
    <div className="flex gap-8 max-md:flex-col">
        <p className="text-muted-foreground text-justify">
            <b>Rotaract </b>
            este o comunitate globală de <b>tineri profesioniști</b> cu vârste
            ...
            organizație mondială renumită. Rotaract combină cuvintele
...
const secondParagraph = (
    <div className="flex gap-8 max-md:flex-col">
        ...
        <p className="text-muted-foreground text-justify">
            ...
            comunitățile locale și <b>încurajează</b> relațiile sociale între
            membri. Rotaract împuternicește tinerii adulți să devină lideri
